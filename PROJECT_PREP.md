...
## Current status (Milestone 3A — 2026-08-20)

Milestone 2A (YouTube curated watchlist), Milestone 2B (regional YouTube `mostPopular`), and Milestone 3A (Hacker News top/new/best stories) are implemented on top of Milestone 1. They persist into the existing tables. FastAPI, Streamlit, analytics, ML, AI, WebSub, Atom, schedulers, Stack Exchange, GitHub, Wikimedia, and GDELT are still out of scope.
...
- Application tables live in `public` and were created by Alembic revision `0001_initial_schema`. Details: [docs/02_DATABASE_SCHEMA.md](docs/02_DATABASE_SCHEMA.md).
