...
| 17 | API contract | Minimum response fields defined (subject, metric, model, interval, horizon, points, origin, history, freshness, caveats) | **REQUIRED** (spec only) | Maps to existing `ForecastResult`; no endpoints invented ([09](09_API_SPEC.md)) |
